...
<html lang="es">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="Img/logoExterno.png" width="230" height="60">
        </a>
    ...
    <div class="container">
         <a class="navbar-brand" href="#">
             <hr>
          <img src="Img/logoExterno.png" >
        </a>
      <h1 class="mt-5">Bienvenido al Sistema de Administración de Viaticos</h1>
      <p>En este sistema se puede llevar un control sobre los viaticos y empleados.</p>
    </div>
    <!-- /.container -->
